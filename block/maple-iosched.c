...
static const int sync_write_expire  = 50;    /* max time before a write sync is submitted. */
static const int async_read_expire = 500;    /* ditto for read async, these limits are SOFT! */
